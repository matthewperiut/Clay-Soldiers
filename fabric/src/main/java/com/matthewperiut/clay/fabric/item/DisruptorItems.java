...
public class DisruptorItems
{
    ...
    public static Item CLAY_DISRUPTOR = registerMiscItem(
                "disruptor/clay", new DisruptorItem(new ClayMaterial(), new FabricItemSettings().maxCount(1)));
    public static Item TERRACOTTA_DISRUPTOR = registerMiscItem(
                "disruptor/terracotta", new DisruptorItem(new TerracottaMaterial(), new FabricItemSettings().maxCount(1)));
    public static Item OBSIDIAN_DISRUPTOR = registerMiscItem(
                "disruptor/obsidian", new DisruptorItem(new FabricItemSettings().maxCount(1)));
