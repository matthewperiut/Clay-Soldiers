...
public class DisruptorItems
{
    ...
    public static final RegistryObject<Item> CLAY_DISRUPTOR = ITEMS.register("disruptor/clay",
            () -> new DisruptorItem(new ClayMaterial(), new Item.Settings().maxCount(1).group(ClayItemGroup.CLAY_MISC_GROUP)));
    public static final RegistryObject<Item> TERRACOTTA_DISRUPTOR = ITEMS.register("disruptor/terracotta",
            () -> new DisruptorItem(new TerracottaMaterial(), new Item.Settings().maxCount(1).group(ClayItemGroup.CLAY_MISC_GROUP)));
    public static final RegistryObject<Item> OBSIDIAN_DISRUPTOR = ITEMS.register("disruptor/obsidian",
            () -> new DisruptorItem(new Item.Settings().maxCount(1).group(ClayItemGroup.CLAY_MISC_GROUP)));
